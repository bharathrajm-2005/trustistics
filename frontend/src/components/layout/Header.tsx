      ...
      <div className="flex items-center gap-2 md:gap-6">
        <div className="relative hidden md:block">
          ...
          <input 
            type="text" 
            placeholder="Search..." 
            className="pl-10 pr-4 py-2 border border-gray-300 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent w-48 lg:w-64 bg-gray-50"
          />
        </div>
        ...
        <div className="flex items-center gap-2 border-l pl-3 md:pl-6 border-gray-200 cursor-pointer">
